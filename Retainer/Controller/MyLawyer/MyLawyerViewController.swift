...
import UIKit
import Firebase
class MyLawyers:UITableViewController{
    let cellId = "cellId"
    
    var users = [user]()
    var messagesController: chatWithLawyer?
    let name = UILabel().getLabel(Text:"My Lawyers", Font: 20, Color: .white, weight: .medium)
